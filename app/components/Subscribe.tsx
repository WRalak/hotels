  ...
  return (
      <div className="flex flex-col items-center w-full max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
          <div className="flex flex-col justify-center items-center text-center">
              ...
              <p className="text-sm md:text-base text-gray-500 mt-4 max-w-2xl">Join our newsletter and be the first to discover new destinations, exclusive offers, and <br /> travel inspiration.</p>
          </div>
